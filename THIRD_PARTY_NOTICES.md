...
`versions.env`. Copies of the libplacebo, FFmpeg, MPV, and Tesseract license
files are installed under `/opt/media/share/licenses` in the image. Subtitle
Edit's license is included in its official release archive under
`/opt/subtitleedit`.
